...
class TX302Page(basepage.Page):

    def open302(self):
        """利用js新开窗口打开302账户并切换页面句柄"""
        js = "window.open('https://ad.qq.com/atlas/18034302/report/analytic?')"
